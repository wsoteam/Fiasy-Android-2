...
public class EventsAdjust {
    ...
    public static final String acept_police = "acept_police";
    public static final String view_onboarding = "view_onboarding";
    ...
    public static final String view_all_articles = "view_all_articles";
    ...
    public static final String view_free_article = "view_free_article";
    public static final String view_paid_article = "view_paid_article";
    public static final String share = "share";

    public static final String view_all_trainings = "view_all_trainings";
