...
public class FragmentSubscriptionGreenUA extends Fragment implements PurchasesUpdatedListener {
    ...
    public static FragmentSubscriptionGreenUA newInstance(boolean isEnterFromMainActivity, String amplitudeComeFrom,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        AmplitudaEvents.logEventViewPremium(getArguments().getString(AMPLITUDE_COME_FROM_TAG), ABConfig.green_P1M_UA);
