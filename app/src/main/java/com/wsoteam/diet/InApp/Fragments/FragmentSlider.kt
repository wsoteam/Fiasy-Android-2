...
import com.wsoteam.diet.presentation.premium.SubscriptionsListFragment
...
import kotlinx.android.synthetic.main.view_custom_toast.*
...
class FragmentSlider: Fragment() {
    ...
    internal val source: String
        get() = activity!!.intent.getStringExtra("source") ?: "profile"
...
//    }
        ...
        findViewById<TextView>(R.id.privacy_policy).apply {
            ...
            text = RichTextUtils.RichText(text)
        ...
        val timerLabel = activity.findViewById<View>(R.id.timer_label)
        ...
        findViewById<TextView>(R.id.title).apply {
            ...
            val spannedLabel = RichTextUtils.RichText(getString(R.string.premium_feature_title__span))
                    .bold()
        ...
        tariffsContainer.addOnScrollListener(object : RecyclerView.OnScrollListener() {
        ...
        reviewsContainer.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrollStateChanged(p: RecyclerView, newState: Int) {
                super.onScrollStateChanged(p, newState)
    ...
    fun purchase(subscriptionId: String) {
        ...
        disposables.add(SubscriptionManager
                ...
                .subscribe(Functions.emptyConsumer(), Consumer { error ->
                    val toast = when (error) {
                        is SubscriptionManager.SubscriptionNotFoundException ->
                            Toast.makeText(this, R.string.subscription_not_found, Toast.LENGTH_SHORT)
                        is SubscriptionManager.SetupFailedException ->
                            Toast.makeText(this, R.string.subscription_not_found, Toast.LENGTH_SHORT)
    ...
    class PlanHolder(val view: PremiumPlanCardView) : RecyclerView.ViewHolder(view)

    open class PlansAdapter(
            val isDarkMode: Boolean = false,
            val withTrial: Boolean = true) : RecyclerView.Adapter<PlanHolder>() {

        open fun getLayoutParams(parent: ViewGroup, viewType: Int): ViewGroup.LayoutParams {
            val width = parent.context.resources.displayMetrics.widthPixels

            return ViewGroup.MarginLayoutParams(width - dp(parent.context, 64f), ViewGroup.LayoutParams.WRAP_CONTENT)
                    .apply {
