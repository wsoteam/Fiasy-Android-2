...
public class FragmentDiary extends Fragment {
    ...
    private void checkFirstRunFru() {
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
        AlertDialog alertDialog = builder.create();
        View view = getLayoutInflater().inflate(R.layout.alert_dialog_grade_fruits, null);
        ...
        ImageButton btnGradeClose = view.findViewById(R.id.btnGradeClose);
        Button btnGradeSend = view.findViewById(R.id.btnGradeSend);
        ImageView ivHeadGrade = view.findViewById(R.id.ivHeadGrade);
        Glide.with(getActivity()).load(R.drawable.fruits_grade_dialog).into(ivHeadGrade);
