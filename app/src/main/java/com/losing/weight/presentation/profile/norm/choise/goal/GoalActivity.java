...
import static com.losing.weight.Config.ONBOARD_PROFILE_PURPOSE;
...
public class GoalActivity extends AppCompatActivity {
    ...
    private void getData() {
        ...
        getSharedPreferences(com.losing.weight.Config.ONBOARD_PROFILE, MODE_PRIVATE).edit().putString(ONBOARD_PROFILE_PURPOSE, oldGoalForSend).commit();
    }
}
