...
import com.losing.weight.BranchOfAnalyzer.POJOClaim.Claim;
...
import com.losing.weight.model.Grade;
...
/*    public static void addWeightDiaryItem(WeightDiaryObject data) {
  ...
  public static void setRecipeInDiaryFromPlan(String day, String meal, String recipeNumber,
    ...
    public static void changePromo(Promo promo){
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference myRef = database.getReference(com.losing.weight.common.promo.Config.promoStoragePath).
                child(promo.getId());
