...
import com.losing.weight.Recipes.adding.pages.IngredientsFragment;
import com.losing.weight.Recipes.adding.pages.InstructionsFragment;
import com.losing.weight.Recipes.adding.pages.MainFragment;
import com.losing.weight.Recipes.adding.pages.ResultFragment;
...
//        vpPager.onTouchEvent(null);
    ...
    public void saveRecipe(RecipeItem recipeItem, List<Food> foods){
        ...
        Events.logCreateRecipe(getIntent().getStringExtra(EventProperties.recipe_from), recipeItem.getName());
        if (isShare) {
