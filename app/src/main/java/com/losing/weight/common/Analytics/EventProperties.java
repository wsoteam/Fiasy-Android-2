...
public class EventProperties {
  ...
  public static final String question_male = "male";
  public static final String question_height = "height";
  public static final String question_weight = "weight";
  public static final String question_age = "age";
  ...
  public static final String recipe_intake_snack = "snack";
  ...
  public static final String trial_from_exercises = "exercises";
  public static final String trial_from_fasting = "fasting";
   ...
   * TeachHostFragment
   */
  public static final String teach_screen = "screen";
  public static final String teach_main = "main";
  public static final String teach_search = "search";
  public static final String teach_add = "add";
  public static final String teach_weight = "weight";
  ...
  public static String purchase_id = "id";
}
