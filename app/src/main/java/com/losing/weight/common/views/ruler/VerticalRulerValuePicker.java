...
public final class VerticalRulerValuePicker extends FrameLayout implements ObservableVerticalScrollView.ScrollChangedListener {
    ...
    private int mNotchColor = Color.BLUE;
        ...
        if (attributeSet != null) {
            ...
            try { //Parse params
                if (a.hasValue(R.styleable.RulerValuePicker_notch_color)) {
                    mNotchColor = a.getColor(R.styleable.RulerValuePicker_notch_color, Color.BLUE);
                }
    ...
    private void calculateNotchPath() {
        ...
        mNotchPath.moveTo(getWidth(), getHeight() / 2 - 30);
        mNotchPath.lineTo(getWidth() - 40, getHeight() / 2);
